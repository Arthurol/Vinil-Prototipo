		...
		<div class="container">
			<div class="form-signin" style="background: #42dea4;">
				...
				<form method="POST" action="valida.php">
					...
					<input type="text" name="usuario" placeholder="Digite a data de gravação" class="form-control"><br>
					
					<!--<label>Gravadora</label>-->
					<input type="password" name="senha" placeholder="Digite o nome da Gravadora" class="form-control"><br>
					
					<!--<label>Gênero</label>-->
					<input type="password" name="senha" placeholder="Digite o gênero do disco" class="form-control"><br>
					
					<!--<label>Preço</label>-->
					<input type="password" name="senha" placeholder="Digite o preço" class="form-control"><br>
