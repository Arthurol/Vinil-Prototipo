...
<title>VINIL - Cadastrar Gravadora</title>
	...
	<div class="formCadastro">
		<form class="cadastro-form">
			<input type="text" placeholder="Id" /> <input type="text"
				...
				placeholder="CNPJ" /> <input type="text"
				placeholder="Endereço" /> <input type="text"
				placeholder="Telefone" />
				
			<a href="AreaVendedor.jsp"><button>Efetuar cadastro</button>
			</a>
		</form>
	</div>
