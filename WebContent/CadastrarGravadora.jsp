	...
	<div class="formCadastro">
		<form class="cadastro-form">
			<input type="text" placeholder="Id" /> <input type="text"
				placeholder="Nome" /> <input type="text" placeholder="CNPJ" /> <input
				type="text" placeholder="Endereço" /> <input type="text"
				placeholder="Telefone" /> <a href="AreaGerente.jsp"><button>Efetuar
					cadastro</button> </a>
		</form>
	</div>
