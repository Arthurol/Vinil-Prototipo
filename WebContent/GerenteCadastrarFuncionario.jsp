...
<body>
	...
	<div id="nav">
		<ul class="menu">
			<li><a href="AreaGerente">Home</a></li>
			...
			<li><a href="#">Seções</a>
				<ul class="submenu-1">
					<li><a href="#">Cadastrar Seção</a></li>
	...
	<div class="formCadastro">
		<form class="cadastro-form">
			<input type="text" placeholder="Id" /> <input type="text"
				placeholder="Título" /> <input type="text" placeholder="Nome" /> <input
				type="text" placeholder="CPF" /> <input type="text"
				placeholder="Cargo" /> <input type="text" placeholder="E-mail" />
			<input type="text" placeholder="Senha" /> <input type="text"
				placeholder="Redigite a senha" /> <a href="AreaGerente.jsp"><button>Efetuar
					cadastro</button></a>
		</form>
	</div>
